...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case 'NEW_CONTACT':
            return { ...state, firstName: '', lastName: '', phone: '', email: '', company: '', project: '', notes: '' };
        case 'ADD_PERSON':
        ...
        case 'SAVE_CONTACT':
            return { ...state, toUpdate: false, detailView: false, firstName: '', lastName: '', phone: '', email: '', company: '', project: '', notes: '', _id: '' };
        case 'DELETE_CONTACT':
